        ...
        <Fragment>
            ...
            <div className="w-full flex flex-col justify-start items-center">
              ...
              "
                ...
                <div
                    className="w-5/6 flex-col flex justify-center md:flex-row md:justify-between gap-5 md:gap-0 items-center">
                    <div className="flex flex-col sm:flex-row  justify-between items-center w-full">
                        ...
                        >
                            {<div className="text-lg font-bold px-3 py-1">جستجو: {
                                filterSubCollection && filterIndustry ?
                                    filterSubCollection + " و " + filterIndustry
                                    :
                                    filterIndustry ?
                                        filterIndustry
                                        :
